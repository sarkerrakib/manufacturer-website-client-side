        ...
        <div className=''>
            <footer className=" footer p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <a className="link link-hover">PTZ Cameras</a>
                    <a className="link link-hover">Recorders</a>
                    <a className="link link-hover">Storage</a>
                    <a className="link link-hover">HDM Cameras</a>
                </div>
                <div>
                    <span className="footer-title">Solutions</span>
                    <a className="link link-hover">Traffic</a>
                    <a className="link link-hover">Building</a>
                    <a className="link link-hover">Critical</a>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p> NetSource Technology. <br/>Providing reliable tech since 1992</p>
                </div>
